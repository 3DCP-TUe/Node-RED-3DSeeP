...
msg.payload = {
    ...
    'mai_water_temp': mai.mai_water_temp?.toFixed(3) ?? NaN,
    'mai_water_temp2': mai.mai_water_temp_mixer_inlet?.toFixed(3) ?? NaN,
    ...
    'material_io_ambient_temperature': material.material_io_ambient_temperature?.toFixed(2) ?? NaN,
    ...
    'material_coriolis_temperature': material.material_coriolis_temperature?.toFixed(3) ?? NaN,
    ...
    'material_bronkhorst_read_temperature': material.material_bronkhorst_read_temperature?.toFixed(3) ?? NaN,
